...
<div className="component-preview">
  <Command style={{ borderRadius: '0.5rem', border: '1px solid var(--component-border)', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', maxWidth: '400px', backgroundColor: 'var(--component-bg)' }}>
    <CommandInput placeholder="명령어 검색..." />
    <CommandList>
      <CommandEmpty>검색 결과가 없습니다.</CommandEmpty>
