...
export const AvatarStatusExample = () => {
  return (
    <div style={{ display: 'flex', gap: '16px' }}>
      <Avatar 
        src="https://i.pravatar.cc/150?img=1" 
...
export const AvatarShapeExample = () => {
  return (
    <div style={{ display: 'flex', gap: '16px' }}>
      <Avatar 
        src="https://i.pravatar.cc/150?img=1" 
...
export const AvatarBorderExample = () => {
  return (
    <div style={{ display: 'flex', gap: '16px', backgroundColor: '#f0f0f0', padding: '16px', borderRadius: '8px' }}>
      <Avatar 
        src="https://i.pravatar.cc/150?img=1" 
        alt="테두리 있는 아바타" 
        border={true}
