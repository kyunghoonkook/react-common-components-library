...
export const DropdownWithSubmenuExample = () => {
  const [isOpen, setIsOpen] = useState(false);
...
export const PositionedDropdownExample = () => {
  const [isOpen, setIsOpen] = useState(false);
...
export const SectionedDropdownExample = () => {
  const [isOpen, setIsOpen] = useState(false);
