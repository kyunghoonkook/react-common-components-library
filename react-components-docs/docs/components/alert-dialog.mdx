...
export const DangerAlertDialogExample = () => {
  const [isOpen, setIsOpen] = useState(false);
...
export const CustomContentAlertDialogExample = () => {
  const [isOpen, setIsOpen] = useState(false);
  const [confirmCode, setConfirmCode] = useState('');
    ...
    <div className="component-preview">
      ...
      >
        <div style={{ marginTop: '1rem' }}>
          ...
          />
          {confirmCode !== 'CONFIRM' && confirmCode !== '' && (
            <p style={{ color: '#f43f5e', marginTop: '0.5rem', fontSize: '0.875rem' }}>
              'CONFIRM'을 정확히 입력하세요
            </p>
          )}
        </div>
...
<CustomContentAlertDialogExample />
