...
export const MultipleRatiosExample = () => {
  return (
    <div className="component-preview">
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '16px' }}>
        <div>
          <h3>16:9 (와이드스크린)</h3>
          <AspectRatio ratio={16 / 9}>
            <div style={{ backgroundColor: 'var(--component-border)', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              16:9
            </div>
          </AspectRatio>
        </div>
...
export const VideoAspectRatioExample = () => {
  return (
    <div className="component-preview">
      <AspectRatio ratio={16 / 9} style={{ maxWidth: '800px' }}>
        <iframe
...
export const CardExample = () => {
  return (
    <div className="component-preview">
      <div style={{ maxWidth: '300px', border: '1px solid var(--component-border)', borderRadius: '8px', overflow: 'hidden', backgroundColor: 'var(--component-bg)' }}>
        <AspectRatio ratio={16 / 9}>
          <img 
            src="https://images.unsplash.com/photo-1527549993586-dff825b37782"
            alt="산 풍경"
