...
import { Textarea } from 'react-components-library';
...
<div className="component-preview" style={{ display: 'flex', flexDirection: 'column', gap: '20px', alignItems: 'stretch', width: '100%' }}>
  <Textarea
    label="작은 크기"
...
export const ControlledTextareaExample = () => {
