...
import { ScrollArea, Button } from 'react-components-library';
...
```jsx
import { ScrollArea } from 'react-components-library';
```
  ...
  return (
    <ScrollArea height={200} width={350}>
      <div style={{ padding: '16px' }}>
        <h4 style={{ marginBottom: '16px', fontSize: '14px', fontWeight: 500, lineHeight: 1 }}>태그</h4>
        {Array.from({ length: 50 }).map((_, i) => (
          <div key={i} style={{ fontSize: '14px', paddingTop: i > 0 ? '8px' : 0 }}>
            태그 {i + 1}
          </div>
        ))}
      </div>
    ...
    >
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={tagItemStyle}>v1.2.0-beta.50</div>
          <div style={tagItemStyle}>v1.2.0-beta.48</div>
          <div style={tagItemStyle}>v1.2.0-beta.47</div>
          <div style={tagItemStyle}>v1.2.0-beta.46</div>
          <div style={tagItemStyle}>v1.2.0-beta.45</div>
          <div style={tagItemStyle}>v1.2.0-beta.44</div>
          <div style={tagItemStyle}>v1.2.0-beta.43</div>
          <div style={tagItemStyle}>v1.2.0-beta.42</div>
          <div style={tagItemStyle}>v1.2.0-beta.41</div>
          <div style={tagItemStyle}>v1.2.0-beta.40</div>
        </div>
      </div>
    </ScrollArea>
  );
          ...
          <thead>
            <tr>
              {Array.from({ length: 10 }).map((_, i) => (
                <th key={i} style={headerCellStyle}>칼럼 {i + 1}</th>
              ))}
            </tr>
          </thead>
          <tbody>
...
export const AlwaysShowExample = () => {
  return (
    <ScrollArea 
      autoHide={false}
      height={200}
    ...
    >
      <div style={{ padding: '16px' }}>
        {Array.from({ length: 30 }).map((_, i) => (
          <div key={i} style={{ paddingTop: i > 0 ? '8px' : 0 }}>
            항목 {i + 1}
          </div>
        ))}
      </div>
...
import { ScrollArea, ScrollAreaRef } from 'react-components-library';
